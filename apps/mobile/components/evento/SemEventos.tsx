import { bgBlack, bgZinc950, centerGrow, fontBold, gapY4, itemsCenter, py4, roundedLg, text3Xl, textLg, textWhite, textZinc400, wFull } from "@/style";
        ...
        <View style={[itemsCenter]}>
            <View style={[itemsCenter, py4, bgZinc950, wFull, roundedLg, gapY4]}>
                ...
                <View>
                    ...
                    <Text style={[textZinc400, textLg]}>Vamos escanear um QA Code?</Text>
                </View>
                <Image source={require('../../assets/images/triangulo.png')} 
